import glob
import pandas as pd
datapath = glob.glob('/Volumes/QCI/NormativeModel/DuiLie/HC/DuiLie_Strufeature/*/*_GrayVol.csv') # TODO: ThickAvg / SurfArea / GrayVol
...
concatenated_data.to_csv('./DLHC_GrayVol.csv') # TODO: ThickAvg / SurfArea / GrayVol
