...
'''
    Execute 400 brain regions in a loop, 
    running 10 brain regions each time.
'''
...
del brainRegion[0:4]
del brainRegion[-1:]
for i in range(0,len(brainRegion),10):
    idps = brainRegion[i:i+10]
    print('------------>',idps)
    # idps = ['LH_Vis_21','LH_Vis_22','LH_Vis_23','LH_Vis_24','LH_Vis_25','LH_Vis_26',
    #         'LH_Vis_27','LH_Vis_28','LH_Vis_29','LH_Vis_30']
    #--构建模型的x、y

    pro_dir = '/Users/qingchen/Documents/code/NormativeModelMDD/Step_4th_NormativeModel/Data/Result_'+str(i)+'/'
