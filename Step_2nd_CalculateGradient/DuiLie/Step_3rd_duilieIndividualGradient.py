...
databox = []
ref = scio.loadmat('/Volumes/QCI/NormativeModel/DuiLie/HC/Duilie_HC_GroupGradient.mat')
...
for i in dataList:
    ...
    savemat('/Volumes/QCI/NormativeModel/DuiLie/HC/DuiLie_IndividualGradient/'+subId+'_gradient.mat',{'data':res})
    ...
    picname = '/Volumes/QCI/NormativeModel/DuiLie/HC/DuiLie_Gradientplot/'+subId+'.png'
