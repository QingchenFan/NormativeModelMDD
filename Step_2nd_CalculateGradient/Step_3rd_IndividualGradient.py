...
path = '/Volumes/qingchen/HCPData/HCPmat/sub*'

dataList = glob.glob(path)
databox = []
ref = scio.loadmat('./GroupGradient.mat')
...
for i in dataList:
    ...
    #savemat('/Volumes/qingchen/HCPData/HCPGradient/'+subId+'_gradient.mat',{'data':res})
    ...
    picname = '/Volumes/qingchen/HCPData/HCPGradientplot/'+subId+'.png'
